...
document.addEventListener("DOMContentLoaded", () => {
                    ...
                    return `
                        ...
                        <div class="cart-part">
                            ...
                            <div class="cart-quantity">
                                ...
                                <span id="quantity-${product.id}" class="quantity-number">${itemCart.count}</span>
                            ...
                            <div onclick="removeItem(${product.id})" class="cart-remove">
    ...
    const totalProducts = async () => {
        ...
        if (cart.length !== 0) {
            let total = cart
                .map((item) => {
                    const product = data.find((itemData) => itemData.id === item.id);
                    return item.count * parseFloat(product.price.replace(/,/g, "")) || 0;
                })
                .reduce((x, y) => x + y, 0);
