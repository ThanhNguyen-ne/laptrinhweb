        ...
        <div class="main-content">
            <div class="product-list">
                <div class="header-product-list">
                    <h2 class="product-title">Thực phẩm Sanest Foods</h2>
                    <div class="sort-container">
                        <label for="sort" class="sort-label">Sắp xếp:</label>
                        <select id="sort" class="sort-select" onchange="location = this.value;">
                            <option value="thucphamsanestfood.php?sort=default" <?= $sort == 'default' ? 'selected' : '' ?>>Mặc định</option>
                            <option value="thucphamsanestfood.php?sort=price_asc" <?= $sort == 'price_asc' ? 'selected' : '' ?>>Giá tăng dần</option>
                            <option value="thucphamsanestfood.php?sort=price_desc" <?= $sort == 'price_desc' ? 'selected' : '' ?>>Giá giảm dần</option>
                        </select>
                    </div>
                </div>
                        ...
                        <?php foreach ($productList as $product): ?>
                            <div class="productCard" id="<?= $product['id'] ?>" onclick="redirectToDetail(<?= $product['id'] ?>)">
                                ...
                                <div class="product-buttons">
                                    <a href="thucphamsanestfood.php?add_to_cart=<?= $product['id'] ?>" class="btn-cart"><i class="fa-solid fa-cart-shopping"></i></a>
